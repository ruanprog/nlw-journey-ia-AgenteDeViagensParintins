...
def loadData():
    loader = WebBaseLoader(
        web_paths=("https://pt.wikipedia.org/wiki/Parintins",),
...
def supervisorAgent(query, llm, webContext, relevant_documents):
    prompt_template = """
    Você é um gerente de uma agência de viagens especializada em Parintins. Sua resposta final deverá ser um roteiro de viagem completo e detalhado.
